# Autogenerated wrapper script for avr_binutils_jll for armv7l-linux-musleabihf
export avr_elfedit, avr_ld, avr_nm, avr_objcopy, avr_objdump, avr_readelf, avr_strip, binutils_strip, ld, nm, objcopy, objdump, readelf
